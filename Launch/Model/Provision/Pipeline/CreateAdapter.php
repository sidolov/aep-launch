...
class CreateAdapter implements PipeInterface
{
    /**
     * @var ProvisionClient
     */
    ...
    public function execute(&$config): void
    {
        ...
        //TODO: throw exception in case of LAUNCH_ADAPTER_ID is absent
    }
    ...
    private function getRequest(string $token, string $property): array
    {
        ...
        return [
            ...
            'url' => 'https://reactor.adobe.io/properties/' . $property . '/hosts',
