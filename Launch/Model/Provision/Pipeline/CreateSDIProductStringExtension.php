...
class CreateSDIProductStringExtension implements PipeInterface
{
    /**
     * @var ProvisionClient
     */
    ...
    public function execute(&$config): void
    {
        $request = $this->getRequest(
            ...
            $config['LAUNCH_EXT_PACKAGE_ID_SDI_PRODUCT_STR']
        );
     ...
     * @param string $sdiProductStringId
     * @return array
     */
    private function getRequest(
        string $token,
        string $propertyId,
        string $sdiProductStringId
    ): array {
        $body = [
            'data' => [
                'attributes' => [
                    'delegate_descriptor_id' => 'aa-product-string-search-discovery::extensionConfiguration::config',
                    'settings' => '{}',
                    'revision' => false,
                ],
                'relationships' => [
