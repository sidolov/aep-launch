...
class CreateConstantDataElementExtension implements PipeInterface
{
    /**
     * @var ProvisionClient
     */
    ...
    public function execute(&$config): void
    {
        $request = $this->getRequest(
            ...
            $config['LAUNCH_EXT_PACKAGE_ID_CONSTANT_DATA_ELEMENT']
        );
     ...
     * @return array
     */
    private function getRequest(string $token, string $propertyId, string $expPackageConstDataElementId)
    {
        $body = [
            'data' => [
                'attributes' => [
                ...
                'relationships' => [
                    'extension_package' => [
                        'data' => [
                            'id' => $expPackageConstDataElementId,
